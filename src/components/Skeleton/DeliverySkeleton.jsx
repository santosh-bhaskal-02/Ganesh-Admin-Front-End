        ...
        <tr key={idx} className="animate-pulse border-b">
          ...
          <td className="px-6 py-4">
            <div className="space-y-2">
              <div className="h-3 w-40 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded-full shadow-inner"></div>
              <div className="h-3 w-32 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded-full shadow-inner"></div>
            </div>
          </td>
          <td className="px-6 py-4">
          ...
          <td className="px-6 py-4">
            <div className="h-8 w-28 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded-md shadow"></div>
          </td>
        </tr>
      ))}
    </>
