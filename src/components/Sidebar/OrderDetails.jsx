...
function OrderDetails() {
  ...
  const progressSteps = [
    ...
    { label: "Payment Successful", icon: <Paid /> },
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
          <div className="flex items-center gap-2 text-gray-700">
            ...
            <span className="font-medium">
              <span className="text-gray-900 font-semibold">Order ID:</span> {order._id}
            </span>
          </div>
          <div className="flex items-center gap-2 text-gray-700">
          ...
          <div className="flex items-center gap-2 text-gray-700">
            ...
            <span className="font-medium">
              ...
              {calculateExpectedDelivery(order.orderDate)}
            </span>
          </div>
        </div>
            ...
            <div className="mt-6 border-t pt-4">
              ...
              <div className="flex justify-between text-gray-700 mb-1">
                <span className="flex items-center gap-1">
                  <AttachMoney fontSize="small" className="text-green-500" /> Subtotal
                </span>
